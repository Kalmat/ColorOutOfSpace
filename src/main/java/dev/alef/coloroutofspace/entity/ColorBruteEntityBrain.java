...
public class ColorBruteEntityBrain extends PiglinBruteBrain {
   ...
   protected static Brain<?> func_242354_a(ColorBruteEntity p_242354_0_, Brain<ColorBruteEntity> p_242354_1_) {
   ...
   protected static void func_242352_a(ColorBruteEntity p_242352_0_) {
   ...
   private static void func_242359_b(ColorBruteEntity p_242354_0_, Brain<ColorBruteEntity> p_242359_1_) {
   ...
   private static void func_242362_c(ColorBruteEntity p_242354_0_, Brain<ColorBruteEntity> p_242362_1_) {
      p_242362_1_.registerActivity(Activity.IDLE, 10, ImmutableList.of(new ForgetAttackTargetTask<>(ColorBruteEntityBrain::func_242349_a), func_242346_a(), func_242356_b(), new FindInteractionAndLookTargetTask(EntityType.PLAYER, 4)));
   }

   private static void func_242364_d(ColorBruteEntity p_242354_0_, Brain<ColorBruteEntity> p_242364_1_) {
   ...
   private static FirstShuffledTask<ColorBruteEntity> func_242346_a() {
   ...
   private static FirstShuffledTask<ColorBruteEntity> func_242356_b() {
   ...
   protected static void func_242358_b(ColorBruteEntity p_242358_0_) {
      Brain<ColorBruteEntity> brain = p_242358_0_.getBrain();
   ...
   private static boolean func_242350_a(ColorBruteEntity p_242354_0_, LivingEntity p_242350_1_) {
   ...
   protected static void func_242353_a(ColorBruteEntity p_242353_0_, LivingEntity p_242353_1_) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
      if (!(p_242353_1_ instanceof AbstractColorEntity)) {
    	  ColorBruteEntityBrain.method.setAccessible(true);
    	  ColorBruteEntityBrain.method.invoke(PiglinTasks.class, p_242353_0_, p_242353_1_);
    	  //PiglinTasks.func_234509_e_(p_242353_0_, p_242353_1_);
      }
   }

   protected static void func_242360_c(ColorBruteEntity p_242360_0_) {
   ...
   private static void func_242363_d(ColorBruteEntity p_242363_0_) {
