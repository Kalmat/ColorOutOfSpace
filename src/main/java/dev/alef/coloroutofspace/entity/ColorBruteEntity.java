...
public class ColorBruteEntity extends AbstractColorEntity {
   protected static final ImmutableList<SensorType<? extends Sensor<? super ColorBruteEntity>>> field_242343_d = ImmutableList.of(SensorType.NEAREST_LIVING_ENTITIES, SensorType.NEAREST_PLAYERS, SensorType.NEAREST_ITEMS, SensorType.HURT_BY, SensorType.PIGLIN_BRUTE_SPECIFIC_SENSOR);
   ...
   public ColorBruteEntity(EntityType<? extends ColorBruteEntity> p_i241917_1_, World p_i241917_2_) {
   ...
   public ILivingEntityData onInitialSpawn(IServerWorld worldIn, DifficultyInstance difficultyIn, SpawnReason reason, @Nullable ILivingEntityData spawnDataIn, @Nullable CompoundNBT dataTag) {
      ColorBruteEntityBrain.func_242352_a(this);
   ...
   protected Brain.BrainCodec<ColorBruteEntity> getBrainCodec() {
      return (Brain.BrainCodec<ColorBruteEntity>) Brain.createCodec(field_242342_bo, field_242343_d);
   }

   protected Brain<?> createBrain(Dynamic<?> dynamicIn) {
      return ColorBruteEntityBrain.func_242354_a(this, this.getBrainCodec().deserialize(dynamicIn));
   }

   @SuppressWarnings("unchecked")
   public Brain<ColorBruteEntity> getBrain() {
      return (Brain<ColorBruteEntity>)super.getBrain();
   }
   ...
   protected void updateAITasks() {
      ...
      ColorBruteEntityBrain.func_242358_b(this);
      ColorBruteEntityBrain.func_242360_c(this);
      super.updateAITasks();
   }
   ...
   public boolean attackEntityFrom(DamageSource source, float amount) {
      ...
      if (this.world.isRemote) {
         ...
         if (flag && source.getTrueSource() instanceof LivingEntity) {
            try {
				ColorBruteEntityBrain.func_242353_a(this, (LivingEntity)source.getTrueSource());
