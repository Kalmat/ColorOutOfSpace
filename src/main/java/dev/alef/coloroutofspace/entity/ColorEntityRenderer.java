...
public class ColorEntityRenderer extends BipedRenderer<MobEntity, PiglinModel<MobEntity>> {
	...
	private static final Map<EntityType<?>, ResourceLocation> field_243503_a = ImmutableMap.of(EntityList.color_brute, new ResourceLocation("textures/entity/piglin/zombified_piglin.png"), 
		   																			 	 	   EntityList.color_anti_player, new ResourceLocation(Refs.MODID, "textures/entity/color_anti_player.png"));
