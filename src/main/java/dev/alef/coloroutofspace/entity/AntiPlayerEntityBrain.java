...
public class AntiPlayerEntityBrain extends PiglinBruteBrain {
   ...
   protected static Brain<?> func_242354_a(AntiPlayerEntity p_242354_0_, Brain<AntiPlayerEntity> p_242354_1_) {
   ...
   protected static void func_242352_a(AntiPlayerEntity p_242352_0_) {
   ...
   private static void func_242359_b(AntiPlayerEntity p_242354_0_, Brain<AntiPlayerEntity> p_242359_1_) {
   ...
   private static void func_242362_c(AntiPlayerEntity p_242354_0_, Brain<AntiPlayerEntity> p_242362_1_) {
      p_242362_1_.registerActivity(Activity.IDLE, 10, ImmutableList.of(new ForgetAttackTargetTask<>(AntiPlayerEntityBrain::func_242349_a), func_242346_a(), func_242356_b(), new FindInteractionAndLookTargetTask(EntityType.PLAYER, 4)));
   }

   private static void func_242364_d(AntiPlayerEntity p_242354_0_, Brain<AntiPlayerEntity> p_242364_1_) {
   ...
   private static FirstShuffledTask<AntiPlayerEntity> func_242346_a() {
   ...
   private static FirstShuffledTask<AntiPlayerEntity> func_242356_b() {
   ...
   protected static void func_242358_b(AntiPlayerEntity p_242358_0_) {
      Brain<AntiPlayerEntity> brain = p_242358_0_.getBrain();
   ...
   private static boolean func_242350_a(AntiPlayerEntity p_242354_0_, LivingEntity p_242350_1_) {
   ...
   protected static void func_242353_a(AntiPlayerEntity p_242353_0_, LivingEntity p_242353_1_) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
      if (!(p_242353_1_ instanceof AbstractColorEntity)) {
    	  AntiPlayerEntityBrain.method.setAccessible(true);
    	  AntiPlayerEntityBrain.method.invoke(PiglinTasks.class, p_242353_0_, p_242353_1_);
    	  //PiglinTasks.func_234509_e_(p_242353_0_, p_242353_1_);
      }
   }

   protected static void func_242360_c(AntiPlayerEntity p_242360_0_) {
   ...
   private static void func_242363_d(AntiPlayerEntity p_242363_0_) {
