...
public class BlockItemList {
    ...
    public static final RegistryObject<Item> WOOD_BLOCK_ITEM = BLOCKITEM_LIST.register("color_wood_block", () -> new BlockItem(BlockList.WOOD_BLOCK.get(), new Item.Properties().group(ItemGroup.BUILDING_BLOCKS)));
    public static final RegistryObject<Item> LEAVES_BLOCK_ITEM = BLOCKITEM_LIST.register("color_leaves_block", () -> new BlockItem(BlockList.LEAVES_BLOCK.get(), new Item.Properties().group(ItemGroup.DECORATIONS)));
    public static final RegistryObject<Item> GRASS_BLOCK_ITEM = BLOCKITEM_LIST.register("color_grass_block", () -> new BlockItem(BlockList.GRASS_BLOCK.get(), new Item.Properties().group(ItemGroup.DECORATIONS)));
    public static final RegistryObject<Item> DIRT_BLOCK_ITEM = BLOCKITEM_LIST.register("color_dirt_block", () -> new BlockItem(BlockList.DIRT_BLOCK.get(), new Item.Properties().group(ItemGroup.BUILDING_BLOCKS)));
}
