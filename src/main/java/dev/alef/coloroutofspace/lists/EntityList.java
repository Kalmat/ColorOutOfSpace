...
public class EntityList {
	...
	public static EntityType<?> color_anti_player = EntityType.Builder.<AntiPlayerEntity>create(AntiPlayerEntity::new, EntityClassification.MONSTER).setCustomClientFactory(AntiPlayerEntity::new).size(0.6F, 1.95F).trackingRange(8).build(Refs.MODID+":color_anti_player");
